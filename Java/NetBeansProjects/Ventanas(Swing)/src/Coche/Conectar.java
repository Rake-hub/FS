...
public class Conectar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Invitado", "Admin", "Super Usuario" }));

        jButton1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/security-protection-protect-key-password-login_108554.png"))); // NOI18N
    ...
    public void comprobarPassword(){
        ...
        try {
            fis = new FileInputStream("clave.txt");
            byte buf[] = new byte[fis.available()];
            fis.read(buf); //lee el fichero

            clave = new String(buf);
        ...
        if (jPasswordField1.getText().equals(clave)) {
