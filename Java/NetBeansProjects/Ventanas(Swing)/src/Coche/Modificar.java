...
import static Coche.Baja.jTextField5;
...
public class Modificar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Introduce la matrícula a cambiar:");

        jLabel12.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel12.setText("Introduce los nuevos datos:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try { 
            for (int i = 0; i < coches.size(); i++) {
                if (coches.get(i).getMatricula().equals(jTextField9.getText())) {
                    repetido = true;
                    coches.get(i).setMatricula(jTextField8.getText());
                    coches.get(i).setMarca(jTextField2.getText());
                    coches.get(i).setModelo(jTextField6.getText());
                    coches.get(i).setMotor(Integer.parseInt(jTextField7.getText()));
                }
            }
            if (repetido) {
